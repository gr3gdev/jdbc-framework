...
class UpdateGeneratorTest : AbstractGeneratorTest() {
    ...
    fun testExecuteErrorAttributes() {
        ...
        QueryGenerator.generate(processingEnvironment, table, "com.github.gr3gdev.jdbc.Person", query)
    }
    ...
    fun testExecute() {
        ...
        Assert.assertEquals("""
@Override
public int update(final com.github.gr3gdev.jdbc.Person person) {
    ...
    try (final Connection cnx = SQLDataSource.getConnection("TEST_DB");
        ...
        throw new JDBCExecutionException(com.github.gr3gdev.jdbc.dao.QueryType.UPDATE, "person", throwables);
    }
}
...
public int update(final java.lang.String lastname, final java.lang.String firstname, final java.lang.Long id) {
    ...
    try (final Connection cnx = SQLDataSource.getConnection("TEST_DB");
        ...
        throw new JDBCExecutionException(com.github.gr3gdev.jdbc.dao.QueryType.UPDATE, "lastname, firstname, id", throwables);
    }
}
        """.trimIndent(), res.second.trimIndent())
    }
